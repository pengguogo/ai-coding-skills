...
>
> 同时覆盖 Vue 和 React 场景。每个检查项标注严重性、规范来源、判断标准和**适用粒度**。
...
### FE-NAME-01 [I] [P1]：组件文件名使用 PascalCase
- **严重性**: important
- **适用粒度**: 模块级
...
### FE-NAME-02 [S] [P2]：工具函数/hooks 文件名使用 camelCase
- **严重性**: suggestion
- **适用粒度**: 模块级
- **规范来源**: coding_standard.md §二·2.1.2 文件与目录命名
- **判断标准**: 非组件文件（utils、hooks、services）使用小驼峰命名

### FE-NAME-03 [I] [P1]：变量和函数使用 camelCase
- **严重性**: important
- **适用粒度**: 模块级
...
### FE-NAME-04 [S] [P2]：常量使用 UPPER_SNAKE_CASE
- **严重性**: suggestion
- **适用粒度**: 模块级
- **规范来源**: coding_standard.md §二·2.1.3 变量与函数命名
- **判断标准**: 模块级常量使用全大写下划线分隔

### FE-NAME-05 [I] [P1]：接口/类型名使用 PascalCase 且语义明确
- **严重性**: important
- **适用粒度**: 模块级
...
### FE-NAME-06 [S] [P2]：事件处理函数使用 handle/on 前缀
- **严重性**: suggestion
- **适用粒度**: 模块级
- **规范来源**: coding_standard.md §二·2.1.3 变量与函数命名
...
### FE-DOC-04 [N] [P2]：TODO/FIXME 须关联任务编号
- **严重性**: nit
- **适用粒度**: 模块级
...
### FE-AI-01 [I] [P1]：Vue SFC 中的 AI 标记位置
- **严重性**: important
- **适用粒度**: 模块级
...
### FE-ARCH-03 [I] [P1]：路由配置与设计文档一致
- **严重性**: important
- **适用粒度**: 模块级
- **规范来源**: frontend-web.md
- **判断标准**: 路由路径、参数、守卫配置须与 `frontend-web.md` 中的路由设计一致

### FE-ARCH-04 [S] [P2]：状态管理方案合理
- **严重性**: suggestion
- **适用粒度**: 模块级
...
### FE-COMP-01 [I] [P1]：Props 定义完整且有类型
- **严重性**: important
- **适用粒度**: 模块级
...
### FE-API-01 [I] [P1]：API 调用封装在 service 层
- **严重性**: important
- **适用粒度**: 模块级
...
### FE-API-04 [B] [P0]：API 路径与设计文档一致
- **严重性**: blocking
- **适用粒度**: 模块级
- **规范来源**: frontend-web.md + backend-design.md
...
### FE-ERR-02 [S] [P2]：异步操作有 loading 和 error 状态
- **严重性**: suggestion
- **适用粒度**: 模块级
